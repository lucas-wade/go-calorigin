...
type CreatePlantingRequest struct {
	...
	LightTypeID       int64   `json:"lightTypeId"`
...
type CreateHarvestRequest struct {
	PlantingID     int64   `json:"plantingId"`
	HarvestTypeID  int64   `json:"harvestTypeId"`
...
type CreateProductRequest struct {
	...
	PlantingQty     int64   `json:"plantingQty,omitempty"`
...
type CreateActivationRequest struct {
	ActivationSiteID    int64   `json:"activationSiteId"`
	StampNoStart        string  `json:"stampNoStart"`
	StampNoEnd          string  `json:"stampNoEnd"`
	StampQty            int64   `json:"stampQty"`
	ProductCatalogID    int64   `json:"productCatalogId"`
	PlantingID          int64   `json:"plantingId"`
	PlantQty            int64   `json:"plantQty"`
	HarvestID           int64   `json:"harvestId"`
	NetWtg              float64 `json:"netWtg"`
	Thc                 float64 `json:"thc"`
	SourceLicenseSiteID int64   `json:"sourceLicenseSiteId"`
	SourceStampQty      int64   `json:"sourceStampQty"`
	SourceStamps        []struct {
...
type CreateTransferRequest struct {
	TransferFromSiteID int64    `json:"transferFromSiteId"`
	TransferToSiteID   int64    `json:"transferToSiteId"`
